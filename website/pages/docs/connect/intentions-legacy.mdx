...
~> **Alert: Deprecation Notice** The intentions system described here was
Consul's original intentions implementation. In Consul 1.9.0 the intentions
system was rewritten and the legacy system was deprecated. The new ACL system
information can be found [here](/docs/connect/intentions).
